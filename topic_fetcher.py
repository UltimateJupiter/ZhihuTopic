...
def get_raw_json(topicid, limit, offset):
    ...
    for i in range(limit):
        try:
            ...
            q_id = vals['id']
            answer_info = get_answers(q_id, min(20, vals['answer_count']))
...
def get_topic(topic_id, q_count):
    ...
    res = Parallel(n_jobs=2, verbose=10)(delayed(get_raw_json)(topic_id, 10, 10 * i) for i in range(int(q_count / 10)))
    return res
